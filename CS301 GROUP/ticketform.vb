Public Class ticketform
    ...
    Private Sub btnConfirm_Click(sender As Object, e As EventArgs) Handles btnConfirm.Click
        ...
        Dim confirmation As DialogResult = MessageBox.Show($"Are you sure you want to confirm this order? {Environment.NewLine}" & $"Total Ticket Price: ${decTotPrice:F2}", "Confirm Order", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
